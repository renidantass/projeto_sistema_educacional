    ...
    <div class="container-fluid h-75">
        <div class="row h-100 my-3">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Cadastro para professor</h5>
                        <form id="formCadProf" method="post" action="../controller/cadastro_professor.php">
                            <div class="form-group">
                                <label for="nome">Nome do professor</label>
                                <input type="text" id="nome" name="nome_professor" class="form-control" placeholder="Seu nome" required>
                            </div>
                            <div class="form-group">
